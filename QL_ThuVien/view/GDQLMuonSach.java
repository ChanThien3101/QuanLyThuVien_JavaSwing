...
public class GDQLMuonSach extends JFrame {
	...
	public GDQLMuonSach() {
		...
		// String data = "" +
		// txtLoaiTaiLieu.getItemAt(txtLoaiTaiLieu.getSelectedIndex());
		...
		add.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				table.setRowCount(0);
				String sql = "INSERT into tblMuonSach ( IDDocGia, TenDocGia, MaTaiLieu, TenTaiLieu, TacGia, LoaiTaiLieu, TinhTrang, NhaXuatBan, NgayMuon, NgayHetHan) VALUES (?,?,?,?,?,?,?,?,?,?)";
		...
		edit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "Update tblMuonSach set TenDocGia = " + "'" + txtTenDocGia.getText() + "'"
						...
						+ ", NgayHetHan = " + "'" + txtNgayHetHan.getText() + "' where IDDocGia = " + "'"
		...
		delete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String sql = "delete from tblMuonSach where IDDocGia = " + "'"
							+ tbl.getValueAt(tbl.getSelectedRow(), 0) + "'";
		...
		search.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String sql = "select * from tblMuonSach where IDDocGia=" + "'" + txtIDDocGia.getText() + "'"
					...
					rst = KetNoiSQL.getStm().executeQuery(sql);
					table.setRowCount(0);
					while (rst.next()) {
	...
	public void loadData() {
		try {
			...
			ResultSet rst = KetNoiSQL.getStm().executeQuery("Select* from tblMuonSach");
			while (rst.next()) {
